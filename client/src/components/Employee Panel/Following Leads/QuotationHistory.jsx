  ...
  const fetchQuotations = async () => {
    try {
      ...
      const quotationsData = response.data;
       ...
       // Sort quotations by date (assuming `quotation_date` is a valid date string)
    const sortedQuotations = quotationsData.sort((a, b) => new Date(b.quotation_date) - new Date(a.quotation_date));
