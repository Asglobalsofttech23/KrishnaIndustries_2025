    ...
    axios
      ...
      .then((response) => {
        if (Array.isArray(response.data)) {
          const sortedLeads = response.data.sort((a, b) => new Date(b.created_at) - new Date(a.created_at));
  ...
  return (
    <div>
      ...
      <Grid container spacing={2} style={{ marginBottom: '40px', marginTop: '30px' }}>
        ...
        <Grid item>
  <Button component={Link} to="/Nextfollowup" variant="contained" color="primary">
    Next Follow
  </Button>
</Grid>
      </Grid>
